...
def main():
    ...
    # load synthetic unit tests
    with open("results/inference/taco_unit_tests/unit_test_by_qwen3_4b_testgen_iter_1_step_100_taco_train_split.json", 'r') as f:
        synthetic_unit_tests_train_split = json.load(f)
        
    with open("results/inference/taco_unit_tests/unit_test_by_qwen3_4b_testgen_iter_1_step_100_taco_test_split.json", 'r') as f:
    ...
    val_dataset = val_dataset.add_column("ground_truth", synthetic_unit_tests_test_split)
    ...
    # save dataset
    breakpoint()
    train_dataset.to_parquet(os.path.join("data", "train_codegen_iter_1_utstep_100_taco.parquet"))
    eval_dataset.to_parquet(os.path.join("data", "eval_codegen_iter_1_utstep_100_taco.parquet"))
