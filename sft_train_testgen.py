...
def main():
    ...
    DEBUG_SAMPLES = 256  # Number of samples for debugging
    
    # Load datasets
    print("Loading datasets...")
    train_dataset = load_parquet_dataset("data/train_trl_sft_testgen_taco.parquet")
    eval_dataset = load_parquet_dataset("data/eval_trl_sft_testgen_taco.parquet")
   ...
   # print(f"Completion: {example['completion'][:100]}...")
    ...
    training_args = SFTConfig(
        # Output and logging
        output_dir="./ckpt/qwen3-4b-sft-taco-testgen",
        run_name="qwen3-4b-sft-taco-testgen",
        ...
        max_length=4096,
        completion_only_loss=False,  # Only compute loss on completion part (generated tests)
